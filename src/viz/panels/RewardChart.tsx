...
export function RewardChart({ rewardHistory, width = 320, height = 120 }: RewardChartProps) {
  ...
  return (
    <div className="w-full max-w-md rounded border border-gray-200 p-4" data-testid="reward-chart">
      <h2 className="mb-2 text-sm font-semibold text-gray-700">Reward History</h2>
      <svg
        width={width}
        height={height}
        viewBox={`0 0 ${width} ${height}`}
        role="img"
        aria-label="Reward history chart"
